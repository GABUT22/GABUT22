...
def helptext ():
        ...
        print "|EX. python2 ras.py (IP Server) -t 999999 -c 100000 -p 80"
        print "|"
        print "|"
        print "|-->Supports attacks : HTTP "
        print "|"
        print "|-->t\tSet number Of Attack"
        ...
        print "|--> =================================== <--"
        print "|"
        print "|-->VERSION TOOLS 2.5"
        print "|"
        print "|-->Tools Modifed By"
        print "|"
        print "|-->Tools Codec By "
        print "|"
        print "|-->[{}]"
        print "|"
        print "|--> ====================== <--|"
...
def sender (num):
        ...
        col()
        print " * | BOT MENYERANG %d [TOBAT MEMEK]" % num
